...
import vn.cahao.hiepkhachhanh.OpenEpubActivity;
...
public class EpubNavigator {
	...
	private OpenEpubActivity activity;
	private static Context context;

	public EpubNavigator(int numberOfBooks, OpenEpubActivity a) {
...
//		}
	...
	public boolean displayTOC(int book) {
		...
		if (books[book] != null)
		{
			//Log.d("books[book]","book:"+book+"books[book].tableOfContents():"+ books[book].tableOfContents());
		...
		{
			res = false;
			Log.d("books[book].tableOfContents():", "" + res);
		}
		Log.d("books[book] :",""+ books[book]);
		return res;
	}
