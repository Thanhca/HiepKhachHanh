...
public class BookView extends SplitPanel {
    ...
    public void onActivityCreated(Bundle saved) {
		...
		// ----- SWIPE PAGE (luot qua chuong moi)
		...
		view.setWebViewClient(new WebViewClient() {
			public boolean shouldOverrideUrlLoading(WebView view, String url) {
				try {
					//capt
					EpubManipulator.checkLinkHtml=true;
					//-------------------------------
		...
		case (MotionEvent.ACTION_UP):
			...
			if ((diffX > quarterWidth) && (absDiffX > absDiffY)) {
				try {
					...
					Animation slideLeftAnimation = AnimationUtils.loadAnimation(getActivity(), R.anim.slide_out_left);
				...
				try {
					...
					Animation slideLeftAnimation = AnimationUtils.loadAnimation(getActivity(), R.anim.slide_out_right);
					view.startAnimation(slideLeftAnimation);
